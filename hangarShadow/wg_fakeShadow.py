...
class myNewWindow(QDialog):
    ...
    def generateShadowJSX(self):
        ...
        lines_save.append(
            '    desc52.putEnumerated( idselectionModifier, idselectionModifierType, idaddToSelectionContinuous );\n')
        lines_save.append('    var idMkVs = charIDToTypeID( "MkVs" );\n')
        ...
        lines_save.append(
            'desc35.putPath( idIn, new File( "' + projectPath + '\\\\' + self.fileName + '_HangarShadowMap.dds" ) );\n')
