...
import math
import validator.utils.validator_API as vl
...
def main():
    ...
    if lod0_hull_turret_polycount + lod0_gun_chassis_polycount > 50000:
        message = "lod0 out of range with " + str(
            lod0_hull_turret_polycount + lod0_gun_chassis_polycount) + " tris > max polycount: " + str(50000) + "\n"
        tmp = []
        tmp.append(message)
    ...
    if lod1_hull_turret_polycount > 0.2 * lod0_hull_turret_polycount:
        message = "lod1 hull & turret out of range with " + str(
            lod1_hull_turret_polycount) + " tris > max polycount: " + str(
            int(math.ceil(0.2 * lod0_hull_turret_polycount))) + "\n"
        tmp = []
        tmp.append(message)
    ...
    if lod1_gun_chassis_polycount > 0.3 * lod0_gun_chassis_polycount:
        message = "lod1 gun & chassis out of range with " + str(
            lod1_gun_chassis_polycount) + " tris > max polycount: " + str(
            int(math.ceil(0.3 * lod0_gun_chassis_polycount))) + "\n"
        tmp = []
        tmp.append(message)
    ...
    if lod2_hull_turret_polycount > 0.1 * lod0_hull_turret_polycount:
        message = "lod2 hull & turret out of range with " + str(
            lod2_hull_turret_polycount) + " tris > max polycount: " + str(
            int(math.ceil(0.1 * lod0_hull_turret_polycount))) + "\n"
        tmp = []
        tmp.append(message)
    ...
    if lod2_gun_chassis_polycount > 0.15 * lod0_gun_chassis_polycount:
        message = "lod2 gun & chassis out of range with " + str(
            lod2_gun_chassis_polycount) + " tris > max polycount: " + str(
            int(math.ceil(0.15 * lod0_gun_chassis_polycount))) + "\n"
        tmp = []
        tmp.append(message)
    ...
    if lod3_hull_turret_polycount > 0.05 * lod0_hull_turret_polycount:
        message = "lod3 hull & turret out of range with " + str(
            lod3_hull_turret_polycount) + " tris > max polycount: " + str(
            int(math.ceil(0.05 * lod0_hull_turret_polycount))) + "\n"
        tmp = []
        tmp.append(message)
    ...
    if lod3_gun_chassis_polycount > 0.075 * lod0_gun_chassis_polycount:
        message = "lod3 gun & chassis out of range with " + str(
            lod3_gun_chassis_polycount) + " tris > max polycount: " + str(
            int(math.ceil(0.075 * lod0_gun_chassis_polycount))) + "\n"
        tmp = []
        tmp.append(message)
