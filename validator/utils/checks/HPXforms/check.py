...
def main():
    ...
    for x in objList:
        ...
        if objPivot[0] < bbx[0] - value or objPivot[0] > bbx[3] + value or objPivot[1] < bbx[1] - value or objPivot[1] > \
                bbx[4] + value or objPivot[2] < bbx[2] - value or objPivot[2] > bbx[5] + value:
            tmp = []
