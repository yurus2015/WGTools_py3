...
def intersection(track, center):
    ...
    hit = mesh.allIntersections(sourcePt, directionVec, None, None, False, OpenMaya.MSpace.kWorld, max_distance, False,
                                None, True, hitPtArray, None, None, None, None, None, 0.0001)
    print('HIT: ', hit)
    return hit
