...
from ta_validator.utils.jsonPreset import PresetsJson
...
class ValidatorMainWindow(QDialog):
	...
	def __init__(self, parent = None):
		...
		#self.centralWidget.setAlignment(Qt.AlignTop)
		self.centralLayout = QVBoxLayout()  #central layout
		...
		for x in data:
			if x == self.current_preset:
				...
				for y in sorted_data:
					...
					checkWidget = CheckWidget(type_error, label, action, fixed)  #create checkWidget instance from checkWidget.py
