...
STYLES = {
    'keyword': format('#74F1C6'),
    'operator': format('red'),
    'brace': format('darkGray'),
    'defclass': format('#F35656'),
    'fromimport': format('#F35656'),
    'string': format('#f0DA5E'),
    'string2': format('#f0DA5E'),
    'comment': format('#666666'),
    'self': format('#FFFFFF'),
...
class PythonHighlighter(QSyntaxHighlighter):
    ...
    def __init__(self, document):
        ...
        rules += [
            ...
            # import
            (r'\bimport\b', 0, STYLES['fromimport']),
            # from
            (r'\bfrom\b', 0, STYLES['fromimport']),
