...
class ActionEditor(QDialog):
    ...
    def createUI(self):
        ...
        self.label_Trash.setPixmap(
            QPixmap(Utils.getCurrentDir() + "\\res\\small_icons\\" + str("icon_trash.png")).scaled(15, 15,
    ...
    def complete(self):
        for i in self.recordList:
            ...
            if i.checkbox.isChecked():
                ...
                try:
                    os.remove(Utils.getCurrentDir().replace("\\",
                                                            "/") + "/res/small_icons/" + "icon_" + i.actionFileName + ".png")
                except:
                    pass
            else:
                # change File DATA
                ...
                if newIcon:
                    ...
                    if i.iconPath:
                        if i.iconPath != Utils.getCurrentDir().replace("\\",
                                                                       "/") + "/res/small_icons/" + "icon_" + i.actionFileName + ".png":
                            shutil.copy2(i.iconPath, Utils.getCurrentDir().replace("\\",
                                                                                   "/") + "/res/small_icons/" + "icon_" + i.actionFileName + ".png")
