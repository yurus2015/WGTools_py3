...
OPTIONS = [2048, 0, 12, 40, 0, 0, 2048] #2048 - defout size, 0 - offset type, 12 percent offset, 40 polycount offset, 0 - color
...
class ToolOptions(QWidget):
	...
	def callback_selection(self):
		...
		self.callback_remove()
		CALLBACKS = []
		selection_changed_callback = OpenMaya.MEventMessage.addEventCallback("SelectionChanged", self.recomend_dimensions)
