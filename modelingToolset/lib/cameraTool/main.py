...
class ToolOptions(QWidget):
    ...
    def main(self):
        ...
        cmds.inViewMessage(amg= '<hl>Please open the tool options to select which camera you want to create</hl>' , pos = 'topLeft', fade = True, fot = 1000)
    ...
    def doCam(self, cameraType = None):
        ...
        if not cmds.ls("camera" + cameraType):
            ...
            cmds.rename(cmds.listRelatives(cmds.ls("camera" + cameraType, l=1)[0], p=1,f=1), "camera"  + cameraType + "Grp")
