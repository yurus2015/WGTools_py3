...
class ToolOptions(QWidget):
    ...
    def createUI(self):
        ...
        self.label = QLabel(
            "<b>Description:</b><ul><li>Recreates an object's UV map</li><li>Uses 'Pixel Ratio' for scaling UV shells</li><li>Rotates all UV shells to make them look nice</li></ul>")
