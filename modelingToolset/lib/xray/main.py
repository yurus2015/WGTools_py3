...
class ToolOptions(QWidget):
    ...
    def createUI(self):
        ...
        self.label  = QLabel("<b>Description:</b><p>Select one or more polygonal objects to apply XRay. <br>Press the button again to exit XRay mode</p>")
    ...
    def main(self):
        ...
        if not selection:
            cmds.inViewMessage(amg= '<hl>Please select one or more polygonal objects</hl>' , pos = 'topLeft', fade = True, fot = 1000)
            return
