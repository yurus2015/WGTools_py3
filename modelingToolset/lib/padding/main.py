...
class Utils(object):
    ...
    def selected(cls):
        ...
        if meshes:
            ...
            cmds.confirmDialog(title='Select meshes', message='Select poligonal mesh', button=['Yes'],
                               defaultButton='Yes')
            return
        ...
        if textures:
            for i in range(len(textures)):
                ...
                if textures[i] == texture:
                    ...
                    mel.eval('textureWindowSelectTexture ' + str(
                        i) + ' polyTexturePlacementPanel1;uvTbUpdateTextureItems polyTexturePlacementPanel1;')
...
class ToolOptions(QWidget):
    ...
    def createUI(self):
        ...
        self.padding_value.valueChanged.connect(
            lambda: Utils.save_option_int('padding_offset', self.padding_value.value()))
        ...
        self.color_intersection_button.clicked.connect(
            lambda: Utils.color_picker(self.color_intersection_button, 'padding_intersect_color'))
