...
class ToolOptions(QWidget):
    ...
    def alignVerts(self):
        ...
        try:
            ...
            cmds.inViewMessage(amg='<hl>Make sure you use correct Distance Tolerance number type</hl>', pos='midCenter',
                               fade=True, fot=1000)
            return
    ...
    def main(self):
        ...
        if not selection:
            cmds.inViewMessage(amg='<hl>Please select components on two meshes (vertices or edges)</hl>',
