...
class ToolOptions(QWidget):
    ...
    def createUI(self):
        ...
        self.label = QLabel(
            "<b>Description:</b><p>Adds rotation animation to all wheels found in the<br> current scene</p>")
    ...
    def main(self, update=0):
        ...
        if not wheels:  # if still no wheels
            cmds.inViewMessage(amg='<hl>Wheels were not found. Please select wheels manually.</hl>', pos='midCenter',
                               fade=True, fot=1000)
            return
