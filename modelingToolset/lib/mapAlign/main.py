...
class ToolOptions(QWidget):
    ...
    def matchUV(self):
        ...
        try:
            ...
            cmds.inViewMessage(amg='<hl>Make sure you use correct Tolerance number type</hl>', pos='midCenter',
                               fade=True, fot=1000)
            return
        ...
        if sourceUV:
            ...
            if sourceUV:
                ...
                cmds.inViewMessage(amg='<hl>Source UVs coincide with target UVs</hl>', pos='midCenter', fade=True,
                                   fot=1000)
        else:
