...
class SG_lodSwitch(QWidget):
	def __init__(self, parent = None):
		...
		self.deleteNodeScriptJob = cmds.scriptJob(uiDeleted=['SimplygonTanks', self.deleteLodNode])
	...
	def initUI(self):
		...
		self.swLods_Slider.setOrientation(QtCore.Qt.Horizontal)
		...
		self.mainLayout.setAlignment(self.textLaybel_01, QtCore.Qt.AlignHCenter)
		self.mainLayout.setAlignment(self.textLaybel_02, QtCore.Qt.AlignHCenter)
		self.mainLayout.setAlignment(self.textLaybel_03, QtCore.Qt.AlignHCenter)
		self.mainLayout.setAlignment(self.textLaybel_04, QtCore.Qt.AlignHCenter)
		self.mainLayout.setAlignment(self.textLaybel_05, QtCore.Qt.AlignHCenter)
		self.mainLayout.setAlignment(self.textLaybel_06, QtCore.Qt.AlignHCenter)
		self.mainLayout.setAlignment(self.textLaybel_07, QtCore.Qt.AlignHCenter)
		...
		self.mainLayout.setAlignment(self.radio1, QtCore.Qt.AlignLeft)
	...
	def switchLodsColorLabel(self, value):
		#print 'Value', value
		allLabelsLod = (self.textLaybel_01, self.textLaybel_02, self.textLaybel_03, self.textLaybel_04, self.textLaybel_05, self.textLaybel_06, self.textLaybel_07)
	...
	def radio2_clicked(self, enabled):
		...
		if enabled and len(lods) > 4:
			...
			self.sliderScriptJob = cmds.scriptJob( attributeChange=[self.lod_switcher + '.activeLevel', self.moveSlider], p = 'SimplygonTanks', rp = 1 )
