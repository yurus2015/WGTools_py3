...
def main():
	...
	hull = re.compile('hull');          hull_list = []
	hull_inside = re.compile('inside'); hull_inside_list = []
	gun = re.compile('gun');            gun_list = []
	turret = re.compile('turret');      turret_list = []
	chassis = re.compile('chassis');    chassis_list = []
	track = re.compile('track');        track_list = []
